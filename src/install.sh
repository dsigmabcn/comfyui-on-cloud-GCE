...
cp comfyui-on-cloud-GCE/src/install_comfyui.sh .
...
cp comfyui-on-cloud-GCE/src/install_extensions.sh ComfyUI
cp comfyui-on-cloud-GCE/src/install_checkpoints.sh ComfyUI
